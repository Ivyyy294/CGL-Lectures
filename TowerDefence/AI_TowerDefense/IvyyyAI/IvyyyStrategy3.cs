...
namespace IvyyyAI
{
    public class IvyyyStrategy3 : AI_Strategy.AbstractStrategy
    {
        ...
        public IvyyyStrategy3(Player player) : base(player)
        {
            ...
            //m_rules.Add(new IvyyySaveResourcesRule(m_worldState));
        }
